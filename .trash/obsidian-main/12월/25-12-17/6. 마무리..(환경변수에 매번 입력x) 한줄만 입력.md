- 깃허브는 100MB 넘으면 못 올리니까 커서한테 다음 실행시키기
@.gitignore 여기에 @midm 이것을 포함시켜줘
...
$env:MIDM_PATH = "C:\Users\hi\Documents\class-fullstack\rag\backend\app\model\midm" # 경로 맞춰주세요

uvicorn backend.app.main:app --host 0.0.0.0 --port 8000

  

--> 터미널 새로 열 때마다 이거 치지 않고 python -m backend.app.main 만 치면 되게하고싶어. 다음 내용을 참고해서 config.py 를 @app 여기에 만들어줘. """"애플리케이션 설정 관리.
